...
int toggle_value = 0;
int effect = 0;
int accumulator, sample, min_ampl, max_ampl, min_in_ADC0, min_in_ADC1, max_in_ADC0, max_in_ADC1;
uint16_t sine_ampl;
uint16_t ampl;
uint32_t max_sample;
...
void setup()
{
  ...
  max_ampl = max_in_ADC0 = max_in_ADC1= 0;
  min_ampl = min_in_ADC0 = min_in_ADC1 = 4095;
...
*/
  ...
  Serial.print(in_ADC1);
  Serial.print(" Min0: ");
  Serial.print(min_in_ADC0);
  Serial.print(" Max0: ");
  Serial.print(max_in_ADC0);
  Serial.print(" Min1: ");
  Serial.print(min_in_ADC1);
  Serial.print(" Max1: ");
  Serial.print(max_in_ADC1);



  Serial.print("  Diff 0 : ");
  Serial.print(max_in_ADC0 - min_in_ADC0);
  Serial.print("  Diff 1 : ");
  Serial.println(max_in_ADC1 - min_in_ADC1);

  if(max_in_ADC0 - min_in_ADC0 == 0 && max_in_ADC1 - min_in_ADC1==0) Serial.println("ZEROZERO");
...
void TC4_Handler()
{
  ...
  max_in_ADC0-=1;  max_in_ADC1 -=1;
  min_in_ADC0+=1; min_in_ADC1 +=1;


  if (ampl > max_ampl) max_ampl = ampl;
  if (ampl < min_ampl) min_ampl = ampl;


  if ( in_ADC0 > max_in_ADC0) max_in_ADC0 = in_ADC0;
  if ( in_ADC1 > max_in_ADC1) max_in_ADC1 = in_ADC1;

  if ( in_ADC0 < min_in_ADC0) min_in_ADC0 = in_ADC0;
  if ( in_ADC1 < min_in_ADC1) min_in_ADC1 = in_ADC1;
